...
<Info>
  No fluxo padrao, nao envie `acquirer`, `pixKey` ou `pixKeyType`.
  Se voce usa ferramentas de atribuicao, envie `tracking_parameters` para receber esses dados tambem no webhook.
</Info>
